...
2. Reads and preprocesses raw Lidar scans.
...
13. Real-time plotting of robot trajectory, scan points, and pose graph.
...
helperposegraphoptimization.m:	Optimizes pose graph to correct trajectory errors.
helperloopclosuredetect.m:	Detects loop closures for correcting global map alignment.

4. Mapping & Feature Detection
...
helperpcalinemerging.m:	Merges detected lines to reduce redundant features.
...
helpertransformfromvector.m:	Converts pose vectors to transformation matrices.
...
# Performance
Execution Time: The SLAM pipeline processes the dataset in ~55.4 seconds.
