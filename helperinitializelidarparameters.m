...
function lidar = helperinitializelidarparameters(type)
switch type
% type 1
    case 1
...
% disp(length(lidar.angles)); 1079 
% starting angle : -2.35 radians
% ending angle : 2.35 radians
% angle increment: angle difference between two adjacent frames. 
% since npoints = 1079 vector has 1079 entries for each beam